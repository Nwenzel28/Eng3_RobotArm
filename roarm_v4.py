...
MIDDLE_DROPOFF_POSES = [
    (RobotPose(0.398835005, 0.108912636, 2.256485739, 0.905048665, -1.222582688, 3.163359633), 0.55),
    (RobotPose(0.348213639, 0.059825251, 2.126097372, 1.113670052, -1.225650921, 2.536621726), 0.14),
]

FRONT_DROPOFF_POSES = [
    (RobotPose(0.654776797, 0.335941793, 1.960427447, 1.11060209, -0.741864204, 3.051087787), 0.62),
    (RobotPose(0.654776797, 0.335941793, 1.960427447, 1.11060209, -0.741864204, 2.551087787), 0.17),
    (RobotPose(0.685689412, 0.141126232, 2.034058525, 1.086058398, -0.889708857, 2.758097457), 0.27),
]
...
PUSH_OFF_POSES = [
    (RobotPose(0.931126338, 0.352815581, 1.684310905, 0.975029284, -0.878971263, 2.721650903), 0.135),
    (RobotPose(0.920388473, 0.415708794, 1.998776967, 0.65761176, -0.878971263, 3.121650903), 0.27),
    (RobotPose(-0.403436947, 0.181009733, 2.462039165, 0.559902988, -1.67165101, 3.118582942), 0.7175),
]
...
def main():
    ...
    sequence = [
        "Home",
        "LeftPickup", "MiddleDropoff",
        "Wait",

        #"LeftPickup", "BackDropoff","Home", "Wait",

        "LeftPickup", "FrontDropoff",
        "Wait",
        
        "PushOff",

        #"PushOnHalf", "Wait", "PushOnFull",
        "Home",
